...
/*
 ...
 e.g
   ...
   But, if Flows are found but there are no Flow templates, then FlowTemplate count will be 0
*/
const minAPI = 45;
...
const enablementRules = [{
  ...
  },
  {
    ...
    threshold: -1,
    recNeg: {
      message: 'Consider using Platform Cache to improve the performance of your application.',
  ...
  },
  {
    ...
    threshold: 0,
    recPos: {
      message: 'Please be aware that there is a hard limit of 100 fields on Activity including managed and unmanged fields'
    }
  },
  {
    metadataType: 'PlatformEventChannel',
    label: 'Platform Events Best Practices',
    threshold: 0,
    recPos: {
  ...
  },
  {
    ...
    label: 'Change Data Capture Best Practices',
    threshold: 0,
    recPos: {
  ...
  {
    metadataType: 'AuraDefinitionBundle',
    label: 'Aura Web Components vs Lightning Web Components',
    threshold: 0,
    recPos: {
  ...
  },
  {
    ...
    threshold: -1,
    recNeg: {
      message: 'Find more information about how to leverage the power of LWC in your application, see this webinar',
...
const qualityRules = [{
    ...
    threshold: minAPI,
    recNeg: {
      message: `You appear to be using a version of Metadata API less than the recommended ${minAPI}`
    }
  },
  {
    ...
    threshold: minAPI,
    recNeg: {
      message: `You appear to be using an API version less than ${minAPI} for this component`
    }
  },
  {
  ...
  },
  {
    ...
    threshold: 0,
    recNeg: {
      message: `Custom Objects should have a description for useability`
    }
  },
  {
    ...
    threshold: 0,
    recNeg: {
      message: `Custom Fields should have a description for useability`
    }
  },
  {
    ...
    threshold: 1,
    recPos: {
      message: 'Best Practices Recommend 1 trigger per object. Please check triggers on the objects below to see if you can use triggers and trigger handlers to reduce the number of triggers per object.'
    }
  },
  {
    ...
    threshold: 1,
    recPos: {
      message: 'Best Practices Recommend  only one record-change process per object. Please check Process Builders on the objects below to see if you can combine all processes into one'
    }
  },
];
